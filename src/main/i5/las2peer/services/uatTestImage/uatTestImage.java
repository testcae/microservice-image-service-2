...
public class uatTestImage extends RESTService {
   ...
   *
   * 
   * @return Response Get response node
   * 
   */
  @GET
  @Path("/image")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Get response node")
  })
   ...
   *
   * 
   * @param payloadPost Payload Post a JSONObject
   * 
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Response post")
  })
