...
/**
 *
 * image-service-2 - Test Class
 *
 * This class provides a basic testing framework for the microservice image-service-2. It was
...
public class uatTestImageTest {
  ...
  public void testpostImage() {
    ...
    try {
      JSONObject imagePayload = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("POST", mainPath + "/image", imagePayload.toJSONString(),
